    ...
    <div className="w-full md:w-[40%] bg-[#8185B2]/10 text-white hidden lg:flex flex-col relative overflow-y-scroll">
      <div className="pt-8 md:pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto">
        <img
          ...
          className="max-w-[80px] md:max-w-[110px] rounded-lg object-cover shadow"
          alt=""
        />
        <h1 className="px-6 md:px-10 text-lg md:text-xl font-medium mx-auto flex items-center gap-2">
          {useritem?.fullname}
        </h1>
        <p className="px-6 md:px-10 mx-auto text-xs md:text-sm">
            ...
            if (item.type === "image") {
              return (
                <img
                  ...
                  src={item.content}
                  alt="media"
                  className="w-12 md:w-16 h-12 md:h-16 object-cover rounded-lg m-1 hover:opacity-80 cursor-pointer"
                />
              );
            }
          })}
